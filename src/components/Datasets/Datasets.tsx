...
export const Datasets = () => {
  ...
  const columns: any = [
    ...
    {
      title: <Tooltip title="Fetal fraction y for trisomy">FFY_for_trisomy</Tooltip>,
    ...
    {
      title: <Tooltip title="Fetal fraction y max">FFY_max</Tooltip>,
    ...
    {
      title: <Tooltip title="Fetal fraction y min">FFY_min</Tooltip>,
